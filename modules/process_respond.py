from modules.ai_crew import ai_crew
import os

def books_to_html(books):
  with open(os.path.join(os.getcwd(), 'template', 'one_card_template.txt'), 'r', encoding='utf-8') as f:
